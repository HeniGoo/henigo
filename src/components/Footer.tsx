          ...
          <Grid item xs={12} sm={6} md={3}>
            <div>
              ...
              <Typography>
                ...
                <br />
                <i className="icon-envelope-alt" /> henabire6161@gmail.com
              </Typography>
            </div>
          </Grid>
          <Grid item xs={12} sm={6} md={3}>
        ...
        <Container>
          <Grid container justifyContent="space-between" alignItems="center">
            ...
            <Grid item>
              <div>
                <MuiLink
                  href="https://www.facebook.com/profile.php?id=100091487782707&mibextid=ZbWKwL"
                  title="Facebook"
                ...
                <MuiLink
                  href="https://www.linkedin.com/in/henok-berhanu-118475244?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app://www.linkedin.com/in/alemayehu-mekonen/"
                  title="LinkedIn"
                  sx={footerStyles.socialLinks}
                >
                  <LinkedIn />
